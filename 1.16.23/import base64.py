...
def generate_alphabet(string, min_output_size=1):
    ...
    return alphabet
alphabet = generate_alphabet(string, min_output_size=1)
...
input_string = "This is a test input string"
min_output_size = 8
alphabet, baseX, alphabet_multiplier, baseX_multiplier, encoded, code = get_optimal_baseX(input_string, min_output_size)
print("Original string:", input_string)
print("Encoded string:", encoded)

# Encode the encoded string using the 1MM algorithm
encoded = encode_1MM(encoded, min_output_size)
print("Encoded string:", encoded)

# print the code used to decode the encoded string
print("Code:", code)

# Decode the encoded string using the 1MM algorithm
decoded = decode_1MM(encoded, min_output_size)
