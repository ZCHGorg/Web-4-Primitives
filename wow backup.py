...
The output should be checked for repeating characters and letters and combinations of characters and letters to compress.  Please update our code to reflect these changes.